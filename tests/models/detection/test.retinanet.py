...
def load_model_from_torch() -> (ir.IRModule, ParametersT):
    ...
    model = model.eval()
    data_transform = torchvision.models.detection.RetinaNet_ResNet50_FPN_Weights.COCO_V1.transforms()
...
tr = Trace.from_expr(expr, params, model_name="retinanet_resnet50_fpn")
tr.checkpoint()
